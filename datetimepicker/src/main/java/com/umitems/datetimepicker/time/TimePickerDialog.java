...
package com.umitems.datetimepicker.time;
...
import com.umitems.datetimepicker.HapticFeedbackController;
import com.umitems.datetimepicker.Utils;
...
public static
TimePickerDialog newInstance(OnTimeSetListener callback,
                             int hourOfDay,
                             int minute,
                             boolean is24HourMode) {
...
public
void initialize(OnTimeSetListener callback, int hourOfDay, int minute, boolean is24HourMode) {
	mCallback = callback;
 ...
 */
public
void setThemeDark(boolean dark) {
	mThemeDark = dark;
}
...
public
void setOnTimeSetListener(OnTimeSetListener callback) {
	mCallback = callback;
}

public
void setStartTime(int hourOfDay, int minute) {
	mInitialHourOfDay = hourOfDay;
	mInitialMinute = minute;
        mInKbMode = false;
    }
