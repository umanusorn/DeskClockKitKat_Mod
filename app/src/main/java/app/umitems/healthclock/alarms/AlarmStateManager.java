 ...
 */
package app.umitems.healthclock.alarms;
...
import app.umitems.healthclock.AlarmAlertWakeLock;
import app.umitems.healthclock.AlarmClockFragment;
import app.umitems.healthclock.AlarmUtils;
import app.umitems.healthclock.AsyncHandler;
import app.umitems.healthclock.DeskClock;
import app.umitems.healthclock.Log;
import app.umitems.healthclock.R;
import app.umitems.healthclock.SettingsActivity;
 ...
 * {@link app.umitems.healthclock.provider.AlarmInstance.LOW_NOTIFICATION_HOUR_OFFSET}. This
 ...
 * {@link app.umitems.healthclock.provider.AlarmInstance.MISSED_TIME_TO_LIVE_HOUR_OFFSET} or until the user acknownledges it.
 *
 * DISMISS_STATE:
