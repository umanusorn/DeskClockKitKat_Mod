package app.umitems.healthclock.stopwatch;
...
import app.umitems.healthclock.CircleTimerView;
...
import app.umitems.healthclock.timer.CountingTimerView;
...
class LapsListAdapter extends BaseAdapter {
	...
	private final long[] mThresholds = {10 * DateUtils.MINUTE_IN_MILLIS, // < 10 minutes
