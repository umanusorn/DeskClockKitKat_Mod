...
/**
 * Class to measure and draw the time in the {@link app.umitems.healthclock.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link app.umitems.healthclock.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
