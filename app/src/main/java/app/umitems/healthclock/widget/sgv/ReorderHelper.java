...
package app.umitems.healthclock.widget.sgv;
...
public
ReorderHelper(StaggeredGridView.ReorderListener listener, StaggeredGridView parentView) {
 ...
 * @return true if the drop results in a reordering, false otherwise.
    ...
    public boolean handleDrop(Point p) {
        ...
        if (reorderTarget != null) {
            final StaggeredGridView.LayoutParams lp = (StaggeredGridView.LayoutParams) reorderTarget.getLayoutParams();
    ...
    private void updateDraggedOverChild(View child) {
        final StaggeredGridView.LayoutParams childLayoutParam = (StaggeredGridView.LayoutParams) child.getLayoutParams();
